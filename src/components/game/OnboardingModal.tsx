...
export function OnboardingModal({ open, onStart }: OnboardingModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="bg-slate-950 border-2 border-accent/80 shadow-[0_0_20px_rgba(255,193,7,0.3)] sm:max-w-md max-h-[98vh] p-4 sm:p-6 w-[98vw] sm:w-full flex flex-col justify-between min-h-[60vh] max-h-[98vh]">
