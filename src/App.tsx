...
const LoadingSpinner = () => (
  <div className="flex flex-col items-center justify-center min-h-screen gap-4">
    <div className="relative">
      ...
      <div className="animate-spin rounded-full h-20 w-20 border-4 border-t-primary border-r-transparent border-b-transparent border-l-transparent absolute top-0 left-0"></div>
    </div>
    <p className="text-sm text-muted-foreground font-sans animate-pulse">Cargando...</p>
  </div>
);
